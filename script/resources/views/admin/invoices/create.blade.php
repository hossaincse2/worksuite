                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-default btn-custome-cancel" href="{{route('admin.all-invoices.index')}}">Cancel</a>
                                    <a class="btn btn-success btn-custome-save save-form" data-type="save" href="#">Save</a>
{{--                                    <a href="javascript:;" class="save-form" data-type="save">--}}
{{--                                        <i class="fa fa-save"></i> @lang('app.save')--}}
{{--                                    </a>--}}
{{--                                    <a class="btn btn-success btn-custome-save" href="#">Send To..</a>--}}
                                    <a href="javascript:void(0);" class="btn btn-success btn-custome-save save-form" data-type="send">
...
{{--                                                <input class="form-controls" type="text" name="last_name" id="last_name" placeholder="Last Name" autocomplete="off">--}}
                                            ...
                                            <input class="form-controls" type="text" name="address1" id="address1" placeholder="Street Address">
                                            <input class="form-controls" type="text" name="address2" placeholder="Street Address 2">
                                            <div class="display-inline2">
                                                <input class="form-controls" name="city" id="city" type="text" placeholder="City">
                                                <input class="form-controls" type="text" name="state" id="state" placeholder="State">
                                            </div>
                                            <input class="form-controls" type="text" name="postal_code" id="postal_code" placeholder="ZIP Code">
                                            <input class="form-controls" type="text" name="country" id="country" placeholder="Country" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="input-icon">
                                                        <input type="text" class="form-controls" name="due_date" id="due_date" value="{{ Carbon\Carbon::today()->format($global->date_format) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                                    </div>--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="input-icon">
                                                        <input type="text" class="form-controls" name="ref" id="ref" value="" placeholder="Enter value (e.g. PO #)">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
