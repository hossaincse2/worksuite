            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <h2 class="pull-left">New Estimate </h2>
                                <div class="pull-right">
                                    <a class="btn btn-default btn-custome-cancel" href="{{route('admin.estimates.index')}}">Cancel</a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="input-icon">
                                                            <input type="text" class="form-controls" name="valid_till" id="valid_till" value="{{ Carbon\Carbon::today()->addDays(30)->format($global->date_format)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
