            ...
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('all-invoices/get-client-info/{id}', ['uses' => 'ManageAllInvoicesController@getClientInfo'])->name('all-invoices.getClientInfo');
        ...
        function () {
            ...
            Route::group(
                ...
                function () {
                    ...
                    Route::get('all-invoices/get-client-info/{id}', ['uses' => 'MemberAllInvoicesController@getClientInfo'])->name('all-invoices.getClientInfo');
